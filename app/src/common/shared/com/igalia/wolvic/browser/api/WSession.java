...
public interface WSession {
    ...
    interface PromptDelegate {
         ...
         */
        interface DatePrompt extends WSession.PromptDelegate.BasePrompt {
            @Retention(RetentionPolicy.SOURCE)
            @IntDef({DatePrompt.Type.DATE, DatePrompt.Type.MONTH, DatePrompt.Type.WEEK, DatePrompt.Type.TIME, DatePrompt.Type.DATETIME_LOCAL})
            ...
            /** One of {@link DatePrompt.Type} indicating the type of prompt. */
         ...
         *
         * @param session ISession that triggered the prompt.
         * @param prompt The {@link DatePrompt} that describes the prompt.
         * @return A {@link WResult} resolving to a {@link WSession.PromptDelegate.PromptResponse} which includes all
         *     necessary information to resolve the prompt.
         */
        @UiThread
        ...
        WResult<PromptResponse> onDateTimePrompt(
                @NonNull final WSession session, @NonNull final DatePrompt prompt) {
            return null;
        }
        ...
        @Nullable
        WResult<PromptResponse> onDatePrompt(@NonNull WSession session, @NonNull DatePrompt prompt);
