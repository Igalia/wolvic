...
public interface WidgetManagerDelegate {
    ...
    @IntDef(value = { WIDGET_MOVE_BEHAVIOUR_GENERAL, WIDGET_MOVE_BEHAVIOUR_KEYBOARD, WIDGET_MOVE_BEHAVIOUR_SNAP})
    ...
    public static final int WIDGET_MOVE_BEHAVIOUR_SNAP = 2;
