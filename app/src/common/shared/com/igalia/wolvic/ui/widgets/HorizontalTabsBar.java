...
public class HorizontalTabsBar extends AbstractTabsBar implements SessionChangeListener {
    ...
    protected void initializeWidgetPlacement(WidgetPlacement aPlacement) {
        ...
        aPlacement.translationZ = 0.0f; // WidgetPlacement.unitFromMeters(getContext(), R.dimen.context_menu_z_distance);
    }
    ...
    public void updateWidgetPlacement() {
        if (mAttachedWindow == null) {
            ...
            mWidgetPlacement.worldWidth = mAttachedWindow.getPlacement().worldWidth; // mWidgetPlacement.width * WidgetPlacement.worldToDpRatio(getContext());
        }
    }
