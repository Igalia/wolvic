...
public class GeckoWebExtension extends WebExtension {
    ...
    class PortId {
        ...
        public String name;
        public Session engineSession;

        PortId(@NonNull String name, @Nullable Session engineSession) {
            this.name = name;
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof PortId) {
                return ((PortId)obj).name.equals(name) && ((PortId)obj).engineSession.getId().equals(engineSession.getId());
            }
        ...
        public String toString() {
            return "PortId(name=" + name + ", engineSession=" + engineSession.getId() + ")";
        }
    }
     ...
     */
    @Override
    public void registerContentMessageHandler(@NonNull Session session, @NonNull String name, @NonNull MessageHandler messageHandler) {
        org.mozilla.geckoview.WebExtension.PortDelegate portDelegate = new org.mozilla.geckoview.WebExtension.PortDelegate() {
            @Override
            public void onPortMessage(@NonNull Object message, @NonNull org.mozilla.geckoview.WebExtension.Port port) {
        ...
        GeckoSession geckoSession = session.getGeckoSession();
        geckoSession.setMessageDelegate(mNativeExtension, messageDelegate, name);
    }

    @Override
    public boolean hasContentMessageHandler(@NonNull Session session, @NonNull String name) {
        GeckoSession geckoSession = session.getGeckoSession();
    ...
    @Nullable
    @Override
    public Port getConnectedPort(@NonNull String name, @Nullable Session session) {
        return mConnectedPorts.get(new PortId(name, session));
    }

    @Override
    public void disconnectPort(@NonNull String name, @Nullable Session session) {
    ...
    class GeckoPort extends Port {
        ...
        void postMessage(@NonNull JSONObject message) {
