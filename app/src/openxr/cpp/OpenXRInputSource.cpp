...
#include "SystemUtils.h"
    ...
    char buildId[128] = {0};
#define HAND_JOINT_FOR_AIM (CompareSemanticVersionStrings(GetBuildIdString(buildId), kPicoVersionInitializeBug) ? XR_HAND_JOINT_WRIST_EXT : XR_HAND_JOINT_PALM_EXT)
#else
